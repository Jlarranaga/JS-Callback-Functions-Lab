...
function writeDing() {
  ...
  console.log('2: ',words.sort(function(a,b){return a.length - b.length}))
  ...
  const longWords = words.filter(function(a) {return a.length > 6});
    console.log('3: ', longWords)  
  ...
  function log(elem, idx) {
    console.log(`4: Index: ${idx} / Element Value: ${elem}`);
  }

  function forEach(arr, func){ //<-- arr = colors[], func = log()
  ...
  forEach(colors, log); //<-- Calling functions and call backs. 
